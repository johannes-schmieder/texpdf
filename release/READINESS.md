...
| `release_scope` | PASS | no | no | kind=public_release_candidate; version=0.1.0-rc2; source=62b8ca066b28c796cee8b7e818c0c0aa795a01f9; required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc'] |
...
| `public_repository_security` | PASS | no | no | visibility=public; audit_tip=62b8ca066b28c796cee8b7e818c0c0aa795a01f9; scope_source=62b8ca066b28c796cee8b7e818c0c0aa795a01f9; sha_pinning=True; vulnerability_reporting=True |
...
| `required_target_source_coherence` | FAIL | yes | yes | required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc']; expected=62b8ca066b28c796cee8b7e818c0c0aa795a01f9; sources=['', '7aa7b16aca8afc75ebfd6aa27a0aa04ab04a47d8'] |
