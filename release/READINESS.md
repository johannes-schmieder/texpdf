...
| `release_scope` | PASS | no | no | kind=public_release_candidate; version=0.1.0-rc2; source=719421d122617317119372534216fadf791f9842; required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc'] |
...
| `public_repository_security` | PASS | no | no | visibility=public; audit_tip=719421d122617317119372534216fadf791f9842; scope_source=719421d122617317119372534216fadf791f9842; sha_pinning=True; vulnerability_reporting=True |
...
| `macos_intel_build` | PASS | no | no | source=53af51d116cf7d885895482b63df37ebf81b6373; plugin_bytes=49377208 |
...
| `required_target_source_coherence` | FAIL | yes | yes | required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc']; expected=719421d122617317119372534216fadf791f9842; sources=['', '719421d122617317119372534216fadf791f9842', '7aa7b16aca8afc75ebfd6aa27a0aa04ab04a47d8'] |
...
| `macos_arm_memory_stress` | PASS | no | no | source=719421d122617317119372534216fadf791f9842; iterations=1000; peak_rss_kib=73616; post_warmup_growth_kib=32; growth_ratio=1.000434877147206 |
