...
| `release_scope` | PASS | no | no | kind=public_release_candidate; version=0.1.0-rc2; source=9f1234d7475f41fb3da4ee5bf36ce33c06ed6ed5; required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc'] |
...
| `public_repository_security` | PASS | no | no | visibility=public; audit_tip=9f1234d7475f41fb3da4ee5bf36ce33c06ed6ed5; scope_source=9f1234d7475f41fb3da4ee5bf36ce33c06ed6ed5; sha_pinning=True; vulnerability_reporting=True |
...
| `required_target_source_coherence` | FAIL | yes | yes | required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc']; expected=9f1234d7475f41fb3da4ee5bf36ce33c06ed6ed5; sources=['', '7aa7b16aca8afc75ebfd6aa27a0aa04ab04a47d8'] |
