...
| `release_scope` | PASS | no | no | kind=public_release_candidate; version=0.1.0-rc2; source=cde50c328e6cb2848d722fba68a4943e2d06ae66; required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc'] |
...
| `public_repository_security` | PASS | no | no | visibility=public; audit_tip=cde50c328e6cb2848d722fba68a4943e2d06ae66; scope_source=cde50c328e6cb2848d722fba68a4943e2d06ae66; sha_pinning=True; vulnerability_reporting=True |
...
| `required_target_source_coherence` | FAIL | yes | yes | required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc']; expected=cde50c328e6cb2848d722fba68a4943e2d06ae66; sources=['', '7aa7b16aca8afc75ebfd6aa27a0aa04ab04a47d8'] |
