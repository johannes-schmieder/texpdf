...
| `release_scope` | PASS | no | no | kind=public_release_candidate; version=0.1.0-rc2; source=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc'] |
...
| `public_repository_security` | PASS | no | no | visibility=public; audit_tip=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; scope_source=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; sha_pinning=True; vulnerability_reporting=True |
| `target_registry` | PASS | no | no | target count=4 |
| `macos_arm_runtime` | PASS | no | no | source=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; plugin_bytes=49709840; Stata=MP 19; exact receipt profile=quick rust_mode=repository-engine |
| `macos_universal_build` | PASS | no | no | architectures=['arm64', 'x86_64']; universal_bytes=99091248; arm_runtime=True |
| `macos_intel_build` | PASS | no | no | source=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; plugin_bytes=49377208 |
...
| `macos_candidate_package` | FAIL | yes | yes | version=0.1.0-rc2; zip_bytes=46559664; license_evidence=True; both_runtimes=True |
...
| `required_target_source_coherence` | FAIL | yes | yes | required_targets=['aarch64-apple-darwin', 'x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc']; expected=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; sources=['', '5fc00576cff0e2731aa6b0a0fefafbe5149a0c59', '7aa7b16aca8afc75ebfd6aa27a0aa04ab04a47d8'] |
...
| `macos_arm_memory_stress` | PASS | no | no | source=5fc00576cff0e2731aa6b0a0fefafbe5149a0c59; iterations=1000; peak_rss_kib=74784; post_warmup_growth_kib=48; growth_ratio=1.0006422607578678 |
